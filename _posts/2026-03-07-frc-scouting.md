...
2. How many times will this team be on the same alliance?
...
- Bot details?
- Auton
- Communication (within drive team)
- Communication (alongst the alliance)
...
### Stand Scouting
My favorite part of competitions, yay!

So, while I was on the team, I would take notes for every match for at least 1 bot, and if needed I would take notes for more teams as seen in by my numerous match notes. In my opinion, it's doable to lock in and take notes for a whole competition, but of course this is not entirely sustainable. 

I think scouting should be split into two main groups:
- Match Notetakers
- Software Scouters
...
1. Autonomous
	- If the notes are for a team, note their pathing, what they do for their auton, and if they can do it well.
	- If the notes are for an alliance, note what they cover as a whole, if any teams don't use their auton, and if there are any accidental interactions (ie, are they bumping into each other, did someone mess up a climb, etc).
